...
@property (NS_NONATOMIC_IOSONLY, getter=isWaiting, readonly) BOOL waiting;
@property (NS_NONATOMIC_IOSONLY, getter=isIdle, readonly) BOOL idle;
@property (NS_NONATOMIC_IOSONLY, getter=isAborted, readonly) BOOL aborted; // return YES if streaming halted due to error (AS_STOPPING + AS_STOPPING_ERROR)
- (void)seekToTime:(double)newSeekTime;
@property (NS_NONATOMIC_IOSONLY, readonly) double calculatedBitRate;
